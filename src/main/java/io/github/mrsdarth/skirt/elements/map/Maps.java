...
public class Maps {
    ...
    static {
        String[] mapDataFiles = new File(Skirtness.getMainWorld().getWorldFolder(), "data").list();
        ...
        Skirtness.registerEvent(MapInitializeEvent.class, event -> MAPS.put(event.getMap().getId(), event.getMap()));
    }
