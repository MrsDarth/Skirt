...
public class EffHideEntity extends Effect {
    ...
    private Class hidepacket = Reflectness.nmsclass("PacketPlayOutEntityDestroy");
        ...
        for (Entity e: entities) {
            if (!(e instanceof Player)) try {
                ...
                for (Player p : players) {
                    Reflectness.sendpacket(p, packet);
                }
            } catch (Exception ex) {
                ex.printStackTrace();
            }
    ...
    private void unhide(Player[] players, Entity[] entities) {
        for (Entity e: entities) {
            if (!(e instanceof Player)) try {
                ...
                Object craftentity = (Reflectness.craftclass("entity.Craft" + l + "Entity").cast(e));
